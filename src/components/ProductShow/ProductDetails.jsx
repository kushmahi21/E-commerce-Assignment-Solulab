  ...
  return (
    ...
    <div className="mt-20 ml-36">
      <Breadcrumb aria-label="Default breadcrumb example">
        ...
        <Breadcrumb.Item href="/ProductDetails/:id">{product.title}</Breadcrumb.Item>
      </Breadcrumb>
      </div>
    ...
    <div className="flex flex-row justify-evenly gap-[30px]">
      <div className=" w-[170px] h-[600px] flex flex-col gap-3">
        <div className="w-[168px] h-[138px] bg-[#F5F5F5] "><img src={product.image} alt="" className="w-[121px] h-[114px] mix-blend-multiply mx-6 my-3 object-contain"/></div>
        <div className="w-[168px] h-[138px] bg-[#F5F5F5] "><img src={product.image} alt="" className="w-[121px] h-[114px] mix-blend-multiply mx-6 my-3 object-contain"/></div>
        <div className="w-[168px] h-[138px] bg-[#F5F5F5] "><img src={product.image} alt="" className="w-[121px] h-[114px] mix-blend-multiply mx-6 my-3 object-contain"/></div>
        <div className="w-[168px] h-[138px] bg-[#F5F5F5] "><img src={product.image} alt="" className="w-[121px] h-[114px] mix-blend-multiply mx-6 my-3 object-contain"/></div> 
      </div>
    ...
    <div className=" w-[400px] min-h-[600px] ">
      ...
      <p className="mt-4 font-poppin text-sm max-h-9 overflow-hidden">{product.description}</p>
